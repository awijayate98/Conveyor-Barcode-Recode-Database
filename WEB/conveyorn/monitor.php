...
<body class="">
      ...
      <div class="content">
          ...
          <div class="col-12">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Heart bpm </h5>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">SPO%</h5>
                <h3 class="card-title"><i class="tim-icons icon-bell-55 text-primary"></i> 763,215</h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
                  <canvas id="chartspo"></canvas>
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="assets/demo/monitor.js"></script>
  <script>
  ...
  <script>
    $(document).ready(function() {
      ...
      monitor.initDashboardPageCharts();
